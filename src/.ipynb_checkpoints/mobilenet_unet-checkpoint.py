...
class MobileV3Unet(nn.Module):
    def __init__(self, num_classes, pretrain_backbone: bool = False):
        ...
        # backbone.load_state_dict(torch.load("./save_weights/mobilenet_v3_large-8738ca79.pth", map_location='cpu'))

        if pretrain_backbone:
        #     # 载入mobilenetv3 large backbone预训练权重
        #     # https://download.pytorch.org/models/mobilenet_v3_large-8738ca79.pth
            backbone.load_state_dict(torch.load("mobilenet_v3_large-8738ca79.pth", map_location='cpu'))
