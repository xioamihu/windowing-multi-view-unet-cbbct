...
class InceptionUnet(nn.Module):
    def __init__(self, num_classes, pretrain_backbone: bool = False):
        ...
        self.stage_out_channels = [64, 192, 288, 768, 2048]  # densenet201
        self.backbone = IntermediateLayerGetter(backbone, {'Conv2d_2b_3x3': 'stage0', 'Conv2d_4a_3x3': 'stage1',
                                                           'Mixed_5d': 'stage2', 'Mixed_6e': 'stage3', 'Mixed_7c': 'stage4'})
...
# new_m = IntermediateLayerGetter(backbone, {'Conv2d_2b_3x3': 'stage0', 'Conv2d_4a_3x3': 'stage1', 'Mixed_5d': 'stage2',
#                                            'Mixed_6e': 'stage3', 'Mixed_7c': 'stage4'})
# out = new_m(x)
# print([(k, v.shape) for k, v in out.items()])
# model = InceptionUnet(num_classes=2)
# # print(model)
